...
* We recommend that you select all the DevExpress products when you run the installation. This registers local NuGet package sources and the item and project templates.
