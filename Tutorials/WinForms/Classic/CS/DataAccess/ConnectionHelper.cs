...
namespace XpoTutorial {
    public static class ConnectionHelper {
        ...
        static IDataLayer CreateDataLayer(bool threadSafe) {
            ...
            AutoCreateOption autoCreateOption = AutoCreateOption.DatabaseAndSchema;  // Use AutoCreateOption.DatabaseAndSchema if the database or tables does not exist. Use AutoCreateOption.SchemaAlreadyExists if the database already exists.
