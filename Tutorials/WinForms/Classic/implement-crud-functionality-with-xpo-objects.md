...
* Add this code to the **btnSave_Click** event handler:
    ...
    ```
* The [UnitOfwork.CommitChanges](https://docs.devexpress.com/XPO/DevExpress.Xpo.UnitOfWork.CommitChanges) method saves changes to the database. To show changes the the **CustomersListForm**, change the code as follows: 
    ```csharp
