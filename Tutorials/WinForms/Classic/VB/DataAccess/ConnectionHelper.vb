...
Namespace XpoTutorial
    Public Module ConnectionHelper
        ...
        Private Function CreateDataLayer(ByVal threadSafe As Boolean) As IDataLayer
            ...
            Dim autoCreateOption As AutoCreateOption = DevExpress.Xpo.DB.AutoCreateOption.DatabaseAndSchema ' Use AutoCreateOption.DatabaseAndSchema if the database or tables does not exist. Use AutoCreateOption.SchemaAlreadyExists if the database already exists.
