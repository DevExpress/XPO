...
Namespace XpoTutorial
    Public Module ConnectionHelper
        ...
        Private Function CreateDataLayer(ByVal threadSafe As Boolean) As IDataLayer
            ...
            Dim autoCreateOption As AutoCreateOption = DevExpress.Xpo.DB.AutoCreateOption.DatabaseAndSchema ' Use AutoCreateOption.DatabaseAndSchema if the database or tables do not exist. Use AutoCreateOption.SchemaAlreadyExists if the database already exists.
